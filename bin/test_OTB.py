...
def evaluation(_type):
    ...
    if config.MACHINE_TYPE == Machine_type.Linux:
        ...
        save_path = r"D:\workspace\MachineLearning\HelloWorld\59version\data\results\eval_result_otb{0}.json".format(
            _type)
...
def validation(args):
    ...
    if config.MACHINE_TYPE == Machine_type.Linux:
        ...
        data_path = r'E:\dataset\OTB'  # "D:\\dataset\\otb\\" # r'E:\dataset\OTB'
...
if __name__ == '__main__':
    ...
    if config.MACHINE_TYPE == Machine_type.Linux:
        args.model_paths = [
            r'/home/selonsy/workspace/SiamFPN/data/models/otb_siamfpn_46_trainloss_1.2423_validloss_nan.pth']  #
        args.save_name = "./data/results/otb_result_otb{0}.json".format(args.videos)
    else:
        args.model_paths = [
            r"D:\workspace\MachineLearning\SiamFPN\data\models\siamfpn_50_trainloss_1.1085_validloss_0.9913.pth"]
        args.save_name = r"D:\workspace\MachineLearning\SiamFPN\data\results\result_otb{0}.json".format(args.videos)
    # 跟踪
    validation(args)
    # 验证
