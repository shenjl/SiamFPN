...
def train(data_dir, model_path=None, vis_port=None, init=None):
    ...
    meta_data = pickle.load(open(meta_data_path,
                                 'rb'))  # meta_data[0] = ('ILSVRC2015_train_00001000', {0: ['000000', '000001', '000002',...]}),
    ...
    for epoch in range(start_epoch, config.EPOCH + 1):
        ...
        for k, data in enumerate(tqdm(trainloader)):  # 这里有问题,loader没有遍历完就跳走了
            ...
            for i in range(len(pred_scores)):
                ...
                reg_loss = rpn_smoothL1(pred_offset, regression_target, conf_target, config.num_pos,
        ...
        if epoch % config.save_interval == 0:
            ...
            save_name = "./data/models/otb_siamfpn_{}_trainloss_{:.4f}_validloss_{:.4f}.pth".format(epoch, train_loss,
                                                                                                    valid_loss)
